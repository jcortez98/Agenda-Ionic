...
CREATE DEFINER=`root`@`localhost` PROCEDURE `set_contacto` (IN `in_idUsuario` INT, IN `in_idContacto` INT, IN `in_nombre` VARCHAR(30), IN `in_apellido` VARCHAR(35), IN `in_direccion` VARCHAR(30), IN `in_telefono` VARCHAR(25), IN `in_correo` VARCHAR(30), IN `in_foto` TEXT, IN `in_idCategoria` INT)  BEGIN
...
(4, '2017-07-05', 'Junta directiva', 30, 19, 'El trebol');
...
(17, 'Manuel', 'Monzon', 'Zona 12', '1212113', 'meme@meme.com', '', 13),
(19, 'Mynor', 'Anal', 'La Florida', '123456', '1212121212', '', 15),
(20, 'Julian', 'Taque', 'La Verbena ', '121212134', 'josejulian@xxx.com', '', 15),
(21, 'Teddy', 'Osito', 'Excesos', '23456781', 'josejulian@xxx.com', '', 16);
...
(46, 'Elimino una categoria', '2017-07-21 19:54:42', 1),
(47, 'Agrego una categoria', '2017-07-21 19:54:49', 1),
(48, 'Agrego una cita', '2017-07-21 19:55:18', 1),
(49, 'Elimino una tarea', '2017-07-21 19:55:34', 1),
(50, 'Elimino una tarea', '2017-07-21 19:55:36', 1),
(51, 'Agrego un contacto', '2017-07-21 20:11:25', 1),
(52, 'Agrego un contacto', '2017-07-21 20:13:00', 1),
(53, 'Elimino una categoria', '2017-07-21 20:51:47', 1),
(54, 'Agrego una categoria', '2017-07-21 20:52:33', 30),
(55, 'Agrego una categoria', '2017-07-21 20:52:46', 30),
(56, 'Agrego una categoria', '2017-07-21 20:52:51', 30),
(57, 'Agrego una categoria', '2017-07-21 20:52:56', 30),
(58, 'Agrego un contacto', '2017-07-21 20:54:19', 30),
(59, 'Agrego una cita', '2017-07-21 20:55:15', 30),
(60, 'Agrego una tarea', '2017-07-21 20:55:53', 30),
(61, 'Agrego un contacto', '2017-07-21 22:03:36', 30),
(62, 'Agrego un contacto', '2017-07-21 22:03:37', 30),
(63, 'Edito un contacto', '2017-07-21 22:04:29', 30),
(64, 'Edito un contacto', '2017-07-21 22:04:29', 30);
...
(9, 'Manuel', 'Elaborar un estudio', '2017-08-19', 30, 1, 15);
...
(1, 'jcortez', '123456', 'nulo'),
(30, 'malay', '123456', 'nulo');
...
--
ALTER TABLE `detallecategoria`
  MODIFY `idDetalleCategoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT de la tabla `detalleusuario`
--
ALTER TABLE `detalleusuario`
  MODIFY `idDetalleUsuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT de la tabla `historial`
--
ALTER TABLE `historial`
  MODIFY `idHistorial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
--
